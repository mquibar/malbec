...
public class MovimientoStock implements Serializable {
    ...
    @ManyToOne
    private ComponenteConservante componente;

    public ComponenteConservante getComponenteConservante() {
        return componente;
    }

    public void setComponenteConservante(ComponenteConservante componenteConservante) {
        this.componente = componenteConservante;
    }
    ...
    public String toString() {
        return "entidades.MovimientoStock[id=" + id + "]";
    }
